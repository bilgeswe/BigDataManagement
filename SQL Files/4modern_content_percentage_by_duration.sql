...
CREATE EXTERNAL TABLE dbo.[table6] (
...
SELECT primary_country, AVG(modern_percentageduration) AS modern_duration_percentage
FROM dbo.[table6]
GROUP BY primary_country
ORDER BY modern_duration_percentage DESC;
GO