...
CREATE EXTERNAL TABLE dbo.[table13] (
...
SELECT TOP 5 primary_country, AVG(classic_percentageduration) AS classic_duration_percentage
FROM dbo.[table13]
GROUP BY primary_country
ORDER BY classic_duration_percentage DESC;
GO